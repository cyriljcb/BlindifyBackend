...
public class BlindtestTest {
    ...
    void should_throw_an_exception_when_blindtestTrack_is_null(){
        ...
        InvalidBlindtestConfigurationException ex = assertThrows(InvalidBlindtestConfigurationException.class, ()->new Blindtest(null, blindtestsettings) );
    ...
    void should_throw_an_exception_when_blindtestTrack_is_empty(){
        ...
        InvalidBlindtestConfigurationException ex = assertThrows(InvalidBlindtestConfigurationException.class, ()->new Blindtest(track, blindtestsettings) );
        assertEquals("Blindtest requires at least one track and valid settings", ex.getMessage());
    }
    @Test
